...
export const LoginScreen: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#12557B] to-[#40B873] flex items-center justify-center p-4">
      <div className="bg-white/10 backdrop-blur-md rounded-3xl p-8 w-full max-w-md text-center border border-white/20 shadow-2xl">
        <div className="mb-8">
          ...
          <p className="text-white/80 text-lg">
            Descubra espaços educativos para um aprendizado interdisciplinar fora da sala de aula
          </p>
        </div>
        ...
        <p className="text-white/60 text-sm mt-6">
          Junte-se à nossa comunidade para explorar e compartilhar saberes
        </p>

        <div className="mt-6 flex justify-center">
          <p className="flex items-center text-white/70 text-sm">
            <Mail className="w-5 h-5 text-white mr-2" />
            Dúvidas? projetoenforifpe@gmail.com
          </p>
        </div>
      </div>
    </div>
