    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          <h2 className="text-2xl font-bold text-gray-900">Espaço não encontrado</h2>
          <button
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center mb-8">
          <h1 className="text-2xl font-bold text-gray-900">
            Editar espaço: {space.name || "Loading..."}
          </h1>
          ...
          <div className="border-b border-gray-200">
            <nav className="-mb-px flex overflow-x-auto" aria-label="Tabs">
              {[
                ...
                { id: "interdisciplinarity", name: "Interdisciplinaridade" },
                { id: "inclusion", name: "Inclusão" },
                { id: "technologies", name: "Tecnologias" },
                { id: "pedagogical", name: "Informações pedagógicas" },
              ].map((tab) => (
                <button
                  key={tab.id}
